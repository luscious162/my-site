...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "liuzhweishan99@gmail.com",
    href: "mailto:liuzhweishan99@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/%E5%80%BC%E5%AE%8F-%E5%88%98-9832a4362/",
    content: "/Liu kanshan",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/luscious162",
    content: "/Liu kanshan",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Liu kanshan</p>
