...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const res = await fetch("https://getform.io/f/bdrnjmwb", {
        method: "POST",
        body: formData,
      });
  ...
  return (
    <form className="min-w-7xl mx-auto sm:mt-4" onSubmit={handleSubmit} method="POST" encType="multipart/form-data">
